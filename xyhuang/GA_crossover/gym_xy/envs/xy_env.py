...
class XyEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.target=None      # target unitary
        self.unitary=None                      
    ...
    def set_pulse(self):
        ...
        self.unitary_ybar = np.dot(expm(-1j*self.H0*(1-self.pw)),expm(-1j*(self.H0*self.pw-np.pi/2/2*self.H_pulse_nSpin(4))))
