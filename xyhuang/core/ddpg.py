...
import numpy as np
from core import torch_grad_inverter
import gym_xy
...
class DDPG(object):
    def __init__(self, args):
        ...
        self.actor_optim = Adam(self.actor.parameters(), lr=0.5e-5)

        self.critic = Critic(args)
        self.critic_target = Critic(args)
        self.critic_optim = Adam(self.critic.parameters(), lr=0.5e-4)
    ...
    def update_parameters(self, batch):
        ...
        #### grad_inv
        grad_inv = torch_grad_inverter.grad_inverter(self.action_b,policy_loss,self.actor.forward((state_batch)))
        policy_loss = grad_inv.grad_inverter_xy
        ###
