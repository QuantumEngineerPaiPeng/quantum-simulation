%20171002
%compute OTOC for time crystal phase transition and consider finite pi-pulse
%width
N_atom=9;
N_rand=10;
...
Disorder=[1.3,0,0]; %Random Lamor freq. is uniformly discributed in [-0.5*Disorder, 0.5*Disorder]
tau=0.16;
width=0.0166;
rho_0=Sigma_y;
